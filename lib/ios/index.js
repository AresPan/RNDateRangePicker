import React, {Text, View, ScrollView, StyleSheet, PropTypes} from 'react-native';
  ...
  render() {
    return (
      <View style={styles.item}>
        <Text style={[styles.itemText, this.props.style]}>{this.props.children}</Text>
      </View>
    );
  }
}
...
export default class extends React.Component {
  ...
  _jsxWeek = () => {
    ...
    return (
      <View style={[styles.week, styles.row]}>
